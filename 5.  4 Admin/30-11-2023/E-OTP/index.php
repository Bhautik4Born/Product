                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countUsers($con) {
                              $query = "SELECT COUNT(id) as total_users FROM E_OTP_register";
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countLanguages($con) {
                              $query = "SELECT COUNT(id) as payment FROM E_OTP_confirm_payment";
                              $result = mysqli_query($con, $query);
                        ...
                        <div class="">
                          <p class="mb-0 fs-6">Payment Detail</p>
                        </div>
                        <div class="">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countCategory($con) {
                              $query = "SELECT COUNT(id) as license FROM E_OTP_license";
                              $result = mysqli_query($con, $query);

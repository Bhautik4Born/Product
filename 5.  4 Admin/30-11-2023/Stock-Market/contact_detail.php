  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">Contact Page</div>
				</div>
				<!--end breadcrumb-->
				<hr/>
							...
							<tbody>
                              <?php
                                ...
                                if (isset($_GET['delete'])) {
                                  ...
                                  $checkIDSql = "SELECT * FROM market_contact WHERE id = ?";
                                  ...
                                  if ($checkIDResult->num_rows > 0) {
                                    $deleteSql = "DELETE FROM market_contact WHERE id = ?";
                                ...
                                $query = "SELECT * FROM market_contact";
                                $result = mysqli_query($con, $query);
                            
                                while ($row = mysqli_fetch_assoc($result)) {
                                //   $userId = $row['id'];
                                  $userName = $row['firstname'];
                                   $emailId= $row['lastname'];
                                  $mobileNo = $row['email'];
                                  $password = $row['text'];
                                  $messaged = $row['message'];

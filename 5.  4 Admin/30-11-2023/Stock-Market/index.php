       ...
       <!--start content-->
          <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3 border-0">Dashboard For TradeCrazyAPI</div>
              <!-- <div class="ms-auto">
                <div class="btn-group">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countLanguages($con) {
                              $query = "SELECT COUNT(id) as payment FROM market_contact";
                              $result = mysqli_query($con, $query);
                        ...
                        <div class="">
                          <p class="mb-0 fs-6">User Contact</p>
                        </div>
                        <div class="">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countCategory($con) {
                              $query = "SELECT COUNT(id) as license FROM market_license";
                              $result = mysqli_query($con, $query);
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countStock($con) {
                              $query = "SELECT COUNT(id) as stock FROM market_Stock";
                              $result = mysqli_query($con, $query);
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countProductStock($con) {
                              $query = "SELECT COUNT(id) as stock FROM market_product";
                              $result = mysqli_query($con, $query);
                        ...
                        <div class="">
                          <p class="mb-0 fs-6">Add Product Stock</p>
                        </div>
                        <div class="">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          <?php
                            function countcoupon($con) {
                              $query = "SELECT COUNT(id) as coupon FROM market_coupon";
                              $result = mysqli_query($con, $query);
                        ...
                        <div class="">
                          <p class="mb-0 fs-6">Total Offer coupon</p>
                        </div>
                        <div class="">

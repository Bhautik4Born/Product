					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
                             ...
                             <tbody>
                              <?php
                              $sql = "SELECT * FROM market_license";
                              ...
                              if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM market_license WHERE id = '$delete_id'";
                              ...
                              if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['license_id'])) {
                                ...
                                $update_query = "UPDATE market_license SET license_key = '$updated_license_key', domain = '$updated_domain' WHERE id = '$license_id'";

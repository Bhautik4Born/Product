  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">Stock</div>
                    <div class="ms-auto">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Stock</button>
                    </div>
				</div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="card-body">
                                ...
                                <h6 class="mb-0 text-center">Add Stock Detail</h6>
                                <hr>
                                <form class="row g-3" method="POST" action="include/add-stock.php">
                                  <div class="col-12">
                                    <label for="single-select" class="form-label">Enter a Stock Name</label>
				...
				<!--end breadcrumb-->
				<hr/>
				<h6 class="	text-uppercase">Stock List</h6>
				<div class="card">
					<div class="card-body">
							...
							<table id="example2" class="table table-striped table-bordered">
                             ...
                             <tbody>
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <form action="" method="post">
                                                  ...
                                                  <div class="mb-3">
                                                    <label for="Stock_name" class="form-label">License Key</label>
                                                    <input type="text" class="form-control" id="Stock_name" name="Stock_name" value="' . $row['Stock_name'] . '">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label for="google_link" class="form-label">google_link</label>
                                                    <input type="text" class="form-control" id="google_link" name="google_link" value="' . $row['google_link'] . '">
                                                  </div>
                              ...
                              if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM market_Stock WHERE id = '$delete_id'";
                              ...
                              if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['license_id'])) {
                                ...
                                $updated_Stock_name = $_POST['Stock_name'];
                                $updated_google_link = $_POST['google_link'];
                            
                                $update_query = "UPDATE market_Stock SET Stock_name = '$updated_Stock_name', google_link = '$updated_google_link' WHERE id = '$license_id'";

  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">Coupon</div>
                    <div class="ms-auto">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Coupon</button>
                    </div>
				</div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="card-body">
                                ...
                                <h6 class="mb-0 text-center">Add Coupon Detail</h6>
                                <hr>
                                <form class="row g-3" method="POST" action="include/offer-coupon.php">
                                  <div class="col-12">
                                    <label for="single-select" class="form-label">Enter a Coupon</label>
				...
				<!--end breadcrumb-->
				<hr/>
				<h6 class="	text-uppercase">Coupon List</h6>
				<div class="card">
					<div class="card-body">
							...
							<table id="example2" class="table table-striped table-bordered">
                             ...
                             <tbody>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel' . $row['id'] . '">Update Coupon</h5>
                              ...
                              if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM market_coupon WHERE id = '$delete_id'";
                              ...
                              if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['license_id'])) {
                                ...
                                $updated_license_key = $_POST['name'];
                                $updated_domain = $_POST['code'];
                                $status = $_POST['status'];
                                $discount = $_POST['discount'];
                            
                                $update_query = "UPDATE market_coupon SET name = '$updated_license_key', code = '$updated_domain', status = '$status', discount = '$discount' WHERE id = '$license_id'";

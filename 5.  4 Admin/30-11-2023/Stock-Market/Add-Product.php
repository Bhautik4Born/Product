  ...
  <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title border-0 pe-3">Stock / Product</div>
                <div class="ms-auto">
                    <!--<button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Stock / Product</button>-->
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModall"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Stock Product</button>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="card-body">
                            <div class="p-3 rounded">
                                <h6 class="mb-0 text-center">Add Stock</h6>
                                <hr>
                                <form class="row g-3" action="include/Add-Product.php" method="POST">
                                    <div class="col-12">
                                        <label class="form-label">Select Stock</label>
                                        <select class="form-select" name="book_name" required="">
                                            <?php
                                            $sql = "SELECT Stock_name , stock_id FROM market_Stock";
                                            $result = mysqli_query($con, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo '<option value="' . $row['stock_id'] . ':' . $row['Stock_name'] . '">' . $row['Stock_name'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control" name="chapter_no" required="">
                                    </div>
                                    <div class="col-12">
            ...
            <!--end breadcrumb-->
            <hr />
            <h6 class="text-uppercase mb-3">Stock / Products List</h6>
                            ...
                            <tbody>
                               <?php
                                        if (isset($_POST['book_id'])) {
                                            ...
                                            $updateSql = "UPDATE market_product SET name = ?, price = ?, quantity = ? WHERE id = ?";
                                            $stmt = $con->prepare($updateSql);
                                            $stmt->bind_param("sssi",$bookName, $authorName, $rating, $bookID);
                                        ...
                                        if (isset($_GET['delete'])) {
                                            $bookID = $_GET['delete'];
                                            $deleteSql = "DELETE FROM market_product WHERE id = ?";
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="author_name" class="form-label">Price</label>
                                                                <input type="text" class="form-control" id="author_name" name="author_name" value="<?php echo $row['price']; ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="rating" class="form-label">Quantity</label>

  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">Keys</div>
                    <div class="ms-auto">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Keys</button>
                    </div>
				</div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="card-body">
                                ...
                                <h6 class="mb-0 text-center">Add Keys Detail</h6>
                                <hr>
                                <form class="row g-3" method="POST" action="include/add-keys.php">
                                  <div class="col-12">
                                    <label for="single-select" class="form-label">Enter a Keys</label>
				...
				<!--end breadcrumb-->
				<hr/>
				<h6 class="	text-uppercase">Keys List</h6>
				<div class="card">
					<div class="card-body">
							...
							<table id="example2" class="table table-striped table-bordered">
                             ...
                             <tbody>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel' . $row['id'] . '">Update Keys</h5>
                                              ...
                                              <div class="modal-body">
                                                <form action="" method="post">
                                                  ...
                                                  <div class="mb-3">
                                                    <label for="license_key" class="form-label">Keys</label>
                              ...
                              if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM AI_Keys WHERE id = '$delete_id'";
                              ...
                              if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['license_id'])) {
                                ...
                                $update_query = "UPDATE AI_Keys SET license_key = '$updated_license_key', description = '$updated_domain', url = '$url' WHERE id = '$license_id'";

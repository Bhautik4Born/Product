							...
							<tbody>
                              <?php
                                ...
                                if (isset($_GET['delete'])) {
                                  ...
                                  $checkIDSql = "SELECT * FROM AI_contact WHERE id = ?";
                                  ...
                                  if ($checkIDResult->num_rows > 0) {
                                    $deleteSql = "DELETE FROM AI_contact WHERE id = ?";
                              ...
                              ?>
                                  <tr>
                                    ...
                                    <td><img src="https://tradecrazyapi.4born.info/<?php echo $profileImage; ?>"></td>
                                    <td>

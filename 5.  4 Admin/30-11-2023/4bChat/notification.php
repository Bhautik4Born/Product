  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">Notifications Add</div>
                    <div class="ms-auto">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal"><i class="fadeIn animated bx bx-plus-circle me-2"></i>Add Notifications </button>
                    </div>
				</div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="card-body">
                                ...
                                <h6 class="mb-0 text-center">Add Notifications Detail</h6>
                                <hr>
                                <form class="row g-3" method="POST" action="include/add-notifications.php">
                                  <div class="col-12">
                                    <label for="single-select" class="form-label">Enter a Notifications</label>
				...
				<!--end breadcrumb-->
				<hr/>
				<h6 class="	text-uppercase">Notifications List</h6>
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
                             ...
                             <tbody>
                              <?php
                              $sql = "SELECT * FROM AI_notifications ORDER BY id DESC";
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel' . $row['id'] . '">Update Notifications</h5>
                                              ...
                                              <div class="modal-body">
                                                <form action="" method="post">
                                                  ...
                                                  <div class="mb-3">
                                                    <label for="license_key" class="form-label">Notifications</label>
                                                    <input type="text" class="form-control" id="license_key" name="license_key" value="' . $row['tital'] . '">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label for="description" class="form-label">Domain</label>
                                                    <input type="text" class="form-control" id="description" name="description" value="' . $row['descriptions'] . '">
                                                  </div>
                              ...
                              if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM AI_notifications WHERE id = '$delete_id'";
                              ...
                              if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['license_id'])) {
                                ...
                                $url = $_POST['url'];
                                $updated_domain = $_POST['description'];
                            
                                $update_query = "UPDATE AI_notifications SET tital = '$updated_license_key', descriptions = '$updated_domain', url = '$url' WHERE id = '$license_id'";

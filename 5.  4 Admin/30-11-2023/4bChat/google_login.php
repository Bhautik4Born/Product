  ...
  <div class="wrapper">
       ...
       <main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title border-0 pe-3">AI Register</div>
				</div>
				<!--end breadcrumb-->
				<hr/>
							...
							<tbody>
                              <?php
                                ...
                                if (isset($_GET['delete'])) {
                                  ...
                                  $checkIDSql = "SELECT * FROM AI_login_google WHERE id = ?";
                                  ...
                                  if ($checkIDResult->num_rows > 0) {
                                    $deleteSql = "DELETE FROM AI_login_google WHERE id = ?";
                                ...
                                $query = "SELECT * FROM AI_login_google";
                                $result = mysqli_query($con, $query);
                            
                                while ($row = mysqli_fetch_assoc($result)) {
                                //   $userId = $row['id'];
                                  $userName = $row['google_id'];
                              ...
                              ?>
                                  <tr>
                                    ...
                                    <td><img src="<?php echo $profileImage; ?>" width="50"></td>

							...
							<tbody>
                              <?php
                                ...
                                if (isset($_GET['delete'])) {
                                  ...
                                  $checkIDSql = "SELECT * FROM AI_register WHERE id = ?";
                                  ...
                                  if ($checkIDResult->num_rows > 0) {
                                    $deleteSql = "DELETE FROM AI_register WHERE id = ?";
                              ...
                              ?>
                                  <tr>
                                    ...
                                    <td><img src="https://4bchat.4born.info/<?php echo $profileImage; ?>" width="50"></td>

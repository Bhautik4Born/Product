...
<!-- Mirrored from themes.pixelstrap.net/mega_bot/html/reset-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2023 17:34:00 GMT -->
<head>
...
<body>
    ...
    <section class="login-section section-b-space">
        <a href="index.php"><img src="https://themes.pixelstrap.net/mega_bot/assets/images/logo.svg" class="img-fluid logo-auth"></a>
        <div class="row m-0">
            <div class="col-lg-7 d-sm-block d-none p-0">
                    ...
                    <div>
                        ...
                        <form class="auth-form">
                            <div class="mb-3 form-group">
                                ...
                                <input type="email" placeholder="Enter your mail id" class="form-control" id="emailid">
                            </div>
                            <a href="otp.php" data-cursor="pointer"
                                class="btn-solid btn-absolute text-center mt-3">Reset
                                Password</a>
                        </form>
                    </div>
                </div>

...
<!-- Mirrored from themes.pixelstrap.net/mega_bot/html/terms.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2023 17:34:03 GMT -->
<head>
            ...
            <div class="row">
                    ...
                    <div class="breadcrumb-content">
                        <div>
                            <h2><img src="./assets/images/breadcrumb-title.png" class="img-fluid"
                                    alt="title-effect">Terms & Condition
                            </h2>
                            <p><i class="ri-subtract-line"></i>Rules and guidelines for using this website or mobile
                                app.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-lg-inline-block d-none">
                    <div class="breadcrumb-img">
                        <img src="https://themes.pixelstrap.net/mega_bot/assets/svg/blog-details-vector.svg" class="img-fluid" alt="service">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 m-auto">
                        <div class="blog-main-content mt-0">
                            <h3 c><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg" class="img-fluid" alt="effect">Terms and
                                Conditions</h3>
                            <p>Last updated: June 16, 2023</p>
                            <p>Please read these terms and conditions carefully before using Our Service.</p>
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Interpretation
                                and Definitions</h3>
                            ...
                            <ol>
                                ...
                                <li>
                                    <p>Website refers to 4Bchat AI, accessible from <a data-cursor="pointer"
                                            href="https://themes.pixelstrap.com/4Bchat AI/"
                                            target="_blank">https://themes.pixelstrap.com/4Bchat AI/</a></p>
                                </li>
                                <li>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Acknowledgment
                            </h3>
                            ...
                            <p>Your access to and use of the Service is also conditioned on Your acceptance of and
                                ...
                                using Our Service.</p>
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Links to Other
                                Websites</h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Termination
                            </h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Limitation of
                                Liability</h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Governing Law
                            </h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Disputes
                                Resolution</h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">For European
                                Union (EU) Users</h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">United States
                                Legal Compliance</h3>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Severability
                                and Waiver</h3>
                            <h4>Severability</h4>
                            ...
                            <h3 class="mt-xl-5 mt-md-3 mt-2"><img src="https://themes.pixelstrap.net/mega_bot/assets/svg/title-effect2.svg"
                                    class="img-fluid" alt="effect">Contact Us
                            </h3>
                            <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
                            <ul>
                                <li>
                                    <p>By email: 4Bchat AI@contact.com</p>
                                </li>
                                <li>
                                    <p>By visiting this page on our website: <a data-cursor="pointer"
                                            href="https://themes.pixelstrap.com/4Bchat AI/"

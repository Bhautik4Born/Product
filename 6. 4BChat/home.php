...
$get_user = mysqli_query($con, "SELECT * FROM `AI_login_google` WHERE `google_id`='$id'");
...
<head>
    ...
    <title><?php echo $user['name']; ?> - 4B Chat Login</title>
    <style>
        *,
        *::before,
        *::after {
...
<body>
    ...
    <div class="_container">
        ...
        <div class="_info">
            ...
            <p><?php echo $user['license_key']; ?></p>
            <a href="logout.php">Logout</a>
            <a href="platform/index.php">Start</a>
        </div>
    </div>
</body>

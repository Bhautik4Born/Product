...
<!-- Mirrored from frenify.com/work/envato/frenify/html/techwave/1/notifications.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Oct 2023 08:44:59 GMT -->
<head>
...
<title>Notifications - 4Bchat AI</title>
                            ...
                            <div class="techwave_fn_notifications_list">
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '<div class="notification__item">';
                                        // echo '<a href="notification-single.php?notification=' . $row["id"] . '" class="fn__full_link"></a>';
                                        echo '<a href="#" class="fn__full_link"></a>';
                                        echo '<h2 class="item__title">' . $row["tital"] . '</h2>';
                                        echo '<span class="item__date">' . $row["date"] . '</span>';
                                        echo '</div>';
                                    }
                                } else {

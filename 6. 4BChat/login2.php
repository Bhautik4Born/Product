...
$client->setRedirectUri('https://seamarineservice.in/4BornChat/login.php');
...
if (isset($_GET['code'])) :
    ...
    if (!isset($token["error"])) {
        ...
        if (mysqli_num_rows($get_user) > 0) {
            ...
            $insert = mysqli_query($con, "INSERT INTO `AI_login_google`(`google_id`,`name`,`email`,`profile_image`) VALUES('$id','$full_name','$email','$profile_pic')");

                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="profile.php">License Key</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 table-responsive">
                         <input type="text" style="width: 41rem; margin-bottom: 3rem;" onkeyup="search_animal()" id="searchbar" placeholder="Search Any Stock Name And Stock ID">
                         <table class="table animals table-striped table-bordered order text-center">

...
<head>
    ...
    <meta charset="utf-8" />
    <title>API Buy - Bayya Bitcoin Crypto Currency Template</title>
                            ...
                            <tr class="animals">
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <button type="submit" name="add_to_cart" class="btn btn-primary pull-right btn-proceed">Add to Cart</button>
                                    </form>
                                    <?php
                                     }else{
                                         ?>
